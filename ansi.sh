...
echo -e "\033[32mGreen text \033[0m with nothing interesting alongside."
echo -e "\033[32mGreen text \033[0m with a non-url www.example.org alongside."
echo -e "\033[32mGreen text \033[0m with a url http://www.example.org/ alongside."
echo -e "\033[32mGreen text with a url http://www.example.org/ inside. \033[0m"
